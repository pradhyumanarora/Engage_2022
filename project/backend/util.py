...
def get_user_tokens(access_token):
    user_tokens = SpotifyToken.objects.filter(access_token=access_token)
...
def update_or_create_user_tokens(access_token, token_type, expires_in, refresh_token):
    tokens = get_user_tokens(access_token)
...
def refresh_spotify_token(access_token):
    refresh_token = get_user_tokens(access_token).refresh_token
